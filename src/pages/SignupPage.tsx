            ...
            <div className="w-full max-w-[360px] px-6">
                ...
                <div className="space-y-6">
                    <div className="text-center animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-100">
                        ...
                        <p className="text-[var(--text-secondary)] text-sm mt-1">Start your journey with Deexen AI</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="h-10 flex items-center justify-center gap-2 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded text-sm text-[var(--text-secondary)] hover:bg-[var(--bg-surface-hover)] hover:border-[var(--border-muted)] transition-colors">
