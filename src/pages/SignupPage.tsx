            ...
            <div className="w-full max-w-[360px] px-6">
                ...
                <div className="flex items-center justify-center mb-8">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-white text-lg font-semibold">Deexen</span>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`w-full h-10 px-3 bg-[#141414] border-neutral-800 rounded text-white text-sm placeholder:text-neutral-600 focus:border-orange-500 focus:ring-1 focus:ring-orange-500/50 transition-colors ${emailError ? 'border-red-500/50' : ''}`}
                                        value={email}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="h-10 flex items-center justify-center gap-2 bg-[#141414] border border-neutral-800 rounded text-sm text-neutral-300 hover:bg-[#1a1a1a] hover:border-neutral-700 transition-colors">
